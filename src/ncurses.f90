...
!-------------------------------------------------------------------------------
  integer(C_INT), parameter :: button_released         =  0
  integer(C_INT), parameter :: button_pressed          =  1
  integer(C_INT), parameter :: button_clicked          =  2
  integer(C_INT), parameter :: button_double_clicked   =  3
  integer(C_INT), parameter :: button_triple_clicked   =  4
  integer(C_INT), parameter :: button_moved            =  5
  integer(C_INT), parameter :: wheel_scrolled          =  6
  integer(C_INT), parameter :: button_action_mask      =  7
  integer(C_INT), parameter :: pdc_button_shift        =  8
  integer(C_INT), parameter :: pdc_button_control      = 16
  integer(C_INT), parameter :: pdc_button_alt          = 32
  integer(C_INT), parameter :: button_modifier_mask    = 56
!-------------------------------------------------------------------------------
!
...
!
integer(C_INT),parameter ::  KEY_CODE_YES  = O'400'  ! A wchar_t contains a key code
integer(C_INT),parameter ::  KEY_MIN       = O'401'  ! Minimum curses key
integer(C_INT),parameter ::  KEY_BREAK     = O'401'  ! Break key (unreliable)
integer(C_INT),parameter ::  KEY_SRESET    = O'530'  ! Soft (partial) reset (unreliable)
integer(C_INT),parameter ::  KEY_RESET     = O'531'  ! Reset or hard reset (unreliable)
!
!  These definitions were generated by ./MKkey_defs.sh ./Caps
!
integer(C_INT),parameter ::  KEY_DOWN      = O'402'  ! down-arrow key
integer(C_INT),parameter ::  KEY_UP        = O'403'  ! up-arrow key
integer(C_INT),parameter ::  KEY_LEFT      = O'404'  ! left-arrow key
integer(C_INT),parameter ::  KEY_RIGHT     = O'405'  ! right-arrow key
integer(C_INT),parameter ::  KEY_HOME      = O'406'  ! home key
integer(C_INT),parameter ::  KEY_BACKSPACE = O'407'  ! backspace key
integer(C_INT),parameter ::  KEY_F0        = O'410'  ! Function keys.  Space for 64
!integer(C_INT),parameter ::  KEY_F(n)      = (KEY_F0+(n))'  ! Value of function key n
integer(C_INT),parameter ::  KEY_DL        = O'510'  ! delete-line key
integer(C_INT),parameter ::  KEY_IL        = O'511'  ! insert-line key
integer(C_INT),parameter ::  KEY_DC        = O'512'  ! delete-character key
integer(C_INT),parameter ::  KEY_IC        = O'513'  ! insert-character key
integer(C_INT),parameter ::  KEY_EIC       = O'514'  ! sent by rmir or smir in insert mode
integer(C_INT),parameter ::  KEY_CLEAR     = O'515'  ! clear-screen or erase key
integer(C_INT),parameter ::  KEY_EOS       = O'516'  ! clear-to-end-of-screen key
integer(C_INT),parameter ::  KEY_EOL       = O'517'  ! clear-to-end-of-line key
integer(C_INT),parameter ::  KEY_SF        = O'520'  ! scroll-forward key
integer(C_INT),parameter ::  KEY_SR        = O'521'  ! scroll-backward key
integer(C_INT),parameter ::  KEY_NPAGE     = O'522'  ! next-page key
integer(C_INT),parameter ::  KEY_PPAGE     = O'523'  ! previous-page key
integer(C_INT),parameter ::  KEY_STAB      = O'524'  ! set-tab key
integer(C_INT),parameter ::  KEY_CTAB      = O'525'  ! clear-tab key
integer(C_INT),parameter ::  KEY_CATAB     = O'526'  ! clear-all-tabs key
integer(C_INT),parameter ::  KEY_ENTER     = O'527'  ! enter/send key
integer(C_INT),parameter ::  KEY_PRINT     = O'532'  ! print key
integer(C_INT),parameter ::  KEY_LL        = O'533'  ! lower-left key (home down)
integer(C_INT),parameter ::  KEY_A1        = O'534'  ! upper left of keypad
integer(C_INT),parameter ::  KEY_A3        = O'535'  ! upper right of keypad
integer(C_INT),parameter ::  KEY_B2        = O'536'  ! center of keypad
integer(C_INT),parameter ::  KEY_C1        = O'537'  ! lower left of keypad
integer(C_INT),parameter ::  KEY_C3        = O'540'  ! lower right of keypad
integer(C_INT),parameter ::  KEY_BTAB      = O'541'  ! back-tab key
integer(C_INT),parameter ::  KEY_BEG       = O'542'  ! begin key
integer(C_INT),parameter ::  KEY_CANCEL    = O'543'  ! cancel key
integer(C_INT),parameter ::  KEY_CLOSE     = O'544'  ! close key
integer(C_INT),parameter ::  KEY_COMMAND   = O'545'  ! command key
integer(C_INT),parameter ::  KEY_COPY      = O'546'  ! copy key
integer(C_INT),parameter ::  KEY_CREATE    = O'547'  ! create key
integer(C_INT),parameter ::  KEY_END       = O'550'  ! end key
integer(C_INT),parameter ::  KEY_EXIT      = O'551'  ! exit key
integer(C_INT),parameter ::  KEY_FIND      = O'552'  ! find key
integer(C_INT),parameter ::  KEY_HELP      = O'553'  ! help key
integer(C_INT),parameter ::  KEY_MARK      = O'554'  ! mark key
integer(C_INT),parameter ::  KEY_MESSAGE   = O'555'  ! message key
integer(C_INT),parameter ::  KEY_MOVE      = O'556'  ! move key
integer(C_INT),parameter ::  KEY_NEXT      = O'557'  ! next key
integer(C_INT),parameter ::  KEY_OPEN      = O'560'  ! open key
integer(C_INT),parameter ::  KEY_OPTIONS   = O'561'  ! options key
integer(C_INT),parameter ::  KEY_PREVIOUS  = O'562'  ! previous key
integer(C_INT),parameter ::  KEY_REDO      = O'563'  ! redo key
integer(C_INT),parameter ::  KEY_REFERENCE = O'564'  ! reference key
integer(C_INT),parameter ::  KEY_REFRESH   = O'565'  ! refresh key
integer(C_INT),parameter ::  KEY_REPLACE   = O'566'  ! replace key
integer(C_INT),parameter ::  KEY_RESTART   = O'567'  ! restart key
integer(C_INT),parameter ::  KEY_RESUME    = O'570'  ! resume key
integer(C_INT),parameter ::  KEY_SAVE      = O'571'  ! save key
integer(C_INT),parameter ::  KEY_SBEG      = O'572'  ! shifted begin key
integer(C_INT),parameter ::  KEY_SCANCEL   = O'573'  ! shifted cancel key
integer(C_INT),parameter ::  KEY_SCOMMAND  = O'574'  ! shifted command key
integer(C_INT),parameter ::  KEY_SCOPY     = O'575'  ! shifted copy key
integer(C_INT),parameter ::  KEY_SCREATE   = O'576'  ! shifted create key
integer(C_INT),parameter ::  KEY_SDC       = O'577'  ! shifted delete-character key
integer(C_INT),parameter ::  KEY_SDL       = O'600'  ! shifted delete-line key
integer(C_INT),parameter ::  KEY_SELECT    = O'601'  ! select key
integer(C_INT),parameter ::  KEY_SEND      = O'602'  ! shifted end key
integer(C_INT),parameter ::  KEY_SEOL      = O'603'  ! shifted clear-to-end-of-line key
integer(C_INT),parameter ::  KEY_SEXIT     = O'604'  ! shifted exit key
integer(C_INT),parameter ::  KEY_SFIND     = O'605'  ! shifted find key
integer(C_INT),parameter ::  KEY_SHELP     = O'606'  ! shifted help key
integer(C_INT),parameter ::  KEY_SHOME     = O'607'  ! shifted home key
integer(C_INT),parameter ::  KEY_SIC       = O'610'  ! shifted insert-character key
integer(C_INT),parameter ::  KEY_SLEFT     = O'611'  ! shifted left-arrow key
integer(C_INT),parameter ::  KEY_SMESSAGE  = O'612'  ! shifted message key
integer(C_INT),parameter ::  KEY_SMOVE     = O'613'  ! shifted move key
integer(C_INT),parameter ::  KEY_SNEXT     = O'614'  ! shifted next key
integer(C_INT),parameter ::  KEY_SOPTIONS  = O'615'  ! shifted options key
integer(C_INT),parameter ::  KEY_SPREVIOUS = O'616'  ! shifted previous key
integer(C_INT),parameter ::  KEY_SPRINT    = O'617'  ! shifted print key
integer(C_INT),parameter ::  KEY_SREDO     = O'620'  ! shifted redo key
integer(C_INT),parameter ::  KEY_SREPLACE  = O'621'  ! shifted replace key
integer(C_INT),parameter ::  KEY_SRIGHT    = O'622'  ! shifted right-arrow key
integer(C_INT),parameter ::  KEY_SRSUME    = O'623'  ! shifted resume key
integer(C_INT),parameter ::  KEY_SSAVE     = O'624'  ! shifted save key
integer(C_INT),parameter ::  KEY_SSUSPEND  = O'625'  ! shifted suspend key
integer(C_INT),parameter ::  KEY_SUNDO     = O'626'  ! shifted undo key
integer(C_INT),parameter ::  KEY_SUSPEND   = O'627'  ! suspend key
integer(C_INT),parameter ::  KEY_UNDO      = O'630'  ! undo key
integer(C_INT),parameter ::  KEY_MOUSE     = O'631'  ! Mouse event has occurred
integer(C_INT),parameter ::  KEY_RESIZE    = O'632'  ! Terminal resize event
integer(C_INT),parameter ::  KEY_EVENT     = O'633'  ! We were interrupted by an event

integer(C_INT),parameter ::  KEY_MAX       = O'777'  ! Maximum key value is 0633
!-------------------------------------------------------------------------------
